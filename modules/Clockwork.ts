...
export class Clockwork {
  ...
  async handleServerStart({ api, kv, log }: ScriptContext): Promise<void> {
    try {
      ...
      // Initialize each setting individually
  ...
  @Command(['clockwork', 'confirm-reset'])
