...
console.log(Deno.env.get("DENO_KV_ACCESS_TOKEN")); // Outputs: "Hello, world."

const API_URL = "http://localhost:8000";
const kv = await Deno.openKv('http://0.0.0.0:4512');

// App 2 (subscriber) - different app, same origin
const channel = new BroadcastChannel("myEvents");
channel.onmessage = (event) => {
  console.log("App 2 received:", event.data);
};
//
